...
public class MedianFinderTest {
	...
	public void testInteger() {
		...
		assertEquals(mf.findMedianInteger(elements), null);

		elements = new ArrayList<>(Arrays.asList(1));
		mf = new MedianFinder();
		assertEquals(mf.findMedianInteger(elements), (Integer) 1);
		...
		mf = new MedianFinder();
		assertEquals(mf.findMedianInteger(elements), (Integer) 15);
		
		elements = new ArrayList<>(Arrays.asList(1, 2, 3));
		mf = new MedianFinder();
		assertEquals(mf.findMedianInteger(elements), (Integer) 2);

		elements = new ArrayList<>(Arrays.asList(1, 2, 3, 4, 5));
		mf = new MedianFinder();
		assertEquals(mf.findMedianInteger(elements), (Integer) 3);
		...
		mf = new MedianFinder();
		assertEquals(mf.findMedianInteger(elements), (Integer) 4);
		...
		mf = new MedianFinder();
		assertEquals(mf.findMedianInteger(elements), (Integer) 5);
