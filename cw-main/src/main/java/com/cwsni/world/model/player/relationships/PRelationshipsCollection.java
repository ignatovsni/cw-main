...
public class PRelationshipsCollection implements IPRelationshipsCollection {
	...
	public void makePeace(PRWar war) {
		...
		int targetId = ComparisonTool.isEqual(game.getCountryId(), war.getAttackerId()) ? war.getDefenderId()
				: war.getAttackerId();
