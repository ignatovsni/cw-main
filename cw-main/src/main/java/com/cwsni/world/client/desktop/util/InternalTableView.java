...
public class InternalTableView extends TableView {

	private final ObservableList<SimpleRow> data = FXCollections.observableArrayList();

	public InternalTableView() {
		super();
	...
	public static class SimpleRow {
		...
		private SimpleRow(String c1, String c2) {
		...
		public void setC2(String v) {
			column2.set(v);
		}
	}

	public void setData(String c1, Object c2) {
		data.add(new SimpleRow(c1, String.valueOf(c2)));
	}
